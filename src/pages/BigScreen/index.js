...
import imgBacUrl from '@/assets/home_bg.jpg'

const imgStyle = {
  backgroundImage: 'url(' + imgBacUrl + ')'
}
    ...
    render(){
        ...
        return (
            <div>
                <div 
                  id={style.menu} 
                  className={`hover_animation ${switchMenu ? style.menu_close: style.menu_open}`} 
                  data-mark={ switchMenu }  
                ...
                <div 
                  id="navgation" 
                  className={`${style.navgation} ${switchMenu ? style.navgation_open: style.navgation_close}`}
                >
